...
# otherwise it will use this example file (example_system_messages.py) as the default.
# 
# ==============================================================================
...
2. Details: Add concrete visual specifics - form, scale, textures, materials, lighting (type, quality, direction, color), shadows, spatial relationships, and environmental context.
